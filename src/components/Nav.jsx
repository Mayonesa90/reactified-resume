        ...
        <Link to="/">
            <header className="relative w-56 ">
                ...
                <div className="flex flex-col gap-4 top-0 w-56 absolute z-0  mt-4">
                    ...
                    <div className=" bg-highlight-h1 h-8 shadow-md shadow-moon"></div>
                    <div className=" bg-highlight-h1 h-8 w-28 shadow-md shadow-moon"></div>
                </div>
            </header>
        </Link>
        <ul className={`font-inria-sans text-2xl col-start-2 ${position} text-right grid gap-y-3 mt-4`}>
            <li>
                <Link to="/about" className={`${highlightAbout} h-8 inline-block pl-2 pr-6 hover:bg-highlight-link shadow-md shadow-moon`}>about</Link>
            </li>
            <li>
                <Link to="/portfolio" className={`${highlightPortfolio} h-8 inline-block pl-2 pr-6 hover:bg-highlight-link shadow-md shadow-moon`}>portfolio</Link>
            </li>
            <li>
                <Link to="/contact" className={`${highlightContact} h-8 inline-block pl-2 pr-6 hover:bg-highlight-link shadow-md shadow-moon`}>contact</Link>
            </li>
        </ul>
    </header>
    </>
